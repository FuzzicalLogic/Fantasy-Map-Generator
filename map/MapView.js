...
MapView.initialize = view => {
    ...
    box.append("g").attr("id", "texture").attr('class', 'Layer Hidden');
    box.append("g").attr("id", "terrs").attr('class', 'Layer Hidden');
    box.append("g").attr("id", "biomes").attr('class', 'Layer Hidden');
    ...
    box.append("g").attr("id", "regions").attr('class', 'Layer Hidden');
    box.append("g").attr("id", "provs").attr('class', 'Layer Hidden');
    ...
    box.append("g").attr("id", "ice").attr('class', 'Layer Hidden');
