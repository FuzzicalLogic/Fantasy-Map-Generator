...
export function toggleAddLabel() {
...
export function toggleAddRoute() {
...
export function toggleAddMarker() {
...
export function viewCellDetails() {
    $("#cellInfo").dialog({
