...
import { findGridCell, findGridAll, findCell, getGridPolygon, getPackPolygon, rn } from "../utils.js";
...
export function editHeightmap() {
    void function selectEditMode() {
      ...
      <p>Check out ${link("https://github.com/Azgaar/Fantasy-Map-Generator/wiki/Heightmap-customization", "wiki")} for guidance.</p>`;
        ...
        $("#alert").dialog({
            resizable: false, title: "Edit Heightmap", width: "28em",
            buttons: {
    ...
    function openImageConverter() {
        ...
        Click "Close" to exit conversion mode and restore previous heightmap`;
            ...
            $("#alert").dialog({
                resizable: false, title: "Close Image Converter",
                buttons: {
                    Cancel: function () {
                        $(this).dialog("close");
                    },
